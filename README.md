...
Arduino 16bits environment is supported p.e. to create Arduino Uno application. Just rename the .C file to .Cpp and add it to the project or the *librairies* folder
