...
void simulate_receive_datagram(unsigned char* datagram, unsigned char length) {
...
#define TEST_RECEIVE_INT16(NAME, DATAGRAM, REFERENCE_VALUE) TEST_RECEIVE(NAME, DATAGRAM, int16)\
  assert_equal_int(REFERENCE_VALUE, status_value, "status_value");\
}
#define TEST_RECEIVE_UINT16(NAME, DATAGRAM, REFERENCE_VALUE) TEST_RECEIVE(NAME, DATAGRAM, uint16)\
  assert_equal_int(REFERENCE_VALUE, status_value, "status_value");\
}
#define TEST_RECEIVE_UINT32(NAME, DATAGRAM, REFERENCE_VALUE) TEST_RECEIVE(NAME, DATAGRAM, uint32)\
  assert_equal_int(REFERENCE_VALUE, status_value, "status_value");\
}

#define DEPTH_BELOW_TRANSDUCER_TEST_VALUE 1234
TEST_RECEIVE_INT16(depth_below_transducer_in_feet_times_10, build_depth_below_transducer(datagram, DEPTH_BELOW_TRANSDUCER_TEST_VALUE, 0, 0, 0), DEPTH_BELOW_TRANSDUCER_TEST_VALUE)
...
TEST_RECEIVE_INT16(apparent_wind_angle, build_apparent_wind_angle(datagram, APPARENT_WIND_ANGLE_TEST_VALUE), APPARENT_WIND_ANGLE_TEST_VALUE / 2)

#define APPARENT_WIND_SPEED_TEST_VALUE 227
TEST_RECEIVE_UINT16(apparent_wind_speed_in_knots_times_10, build_apparent_wind_speed(datagram, APPARENT_WIND_SPEED_TEST_VALUE, 0), APPARENT_WIND_SPEED_TEST_VALUE)

#define HEADING_TEST_VALUE 347
#define HEADING_WITH_RUDDER_TEST_VALUE 015
TEST_RECEIVE(heading, build_heading(datagram, HEADING_TEST_VALUE, 0, 0), int16)
...
TEST_RECEIVE_UINT16(water_speed_in_knots_times_100, build_water_speed(datagram, WATER_SPEED_TEST_VALUE / 10), WATER_SPEED_TEST_VALUE)

#define AVERAGE_WATER_SPEED_TEST_VALUE 619
TEST_RECEIVE_UINT16(average_water_speed_in_knots_times_100, build_average_water_speed(datagram, WATER_SPEED_TEST_VALUE, AVERAGE_WATER_SPEED_TEST_VALUE, 1, 1, 0, 0), AVERAGE_WATER_SPEED_TEST_VALUE)

#define RUDDER_POSITION_TEST_VALUE -10
#define RUDDER_POSITION_AUTOPILOT_TEST_VALUE 13
TEST_RECEIVE(rudder_position_in_degrees_right, build_heading_and_rudder_position(datagram, 0, TURN_DIRECTION_LEFT, RUDDER_POSITION_TEST_VALUE), int16)
...
TEST_RECEIVE_INT16(course_over_ground, build_course_over_ground(datagram, COURSE_OVER_GROUND_TEST_VALUE), COURSE_OVER_GROUND_TEST_VALUE)
...
TEST_RECEIVE_INT16(speed_over_ground_in_knots_times_100, build_speed_over_ground(datagram, SPEED_OVER_GROUND_TEST_VALUE), SPEED_OVER_GROUND_TEST_VALUE * 10)

#define TRIP_MILEAGE_TEST_VALUE 34567
#define TRIP_MILEAGE_WITH_TOTAL_TEST_VALUE 567890
TEST_RECEIVE(trip_mileage_in_nautical_miles_times_100, build_trip_mileage(datagram, TRIP_MILEAGE_TEST_VALUE), uint32)
...
assert_equal_uint32(TRIP_MILEAGE_WITH_TOTAL_TEST_VALUE, status_value, "trip_mileage from build_total_and_trip_mileage()");
}

#define TOTAL_MILEAGE_TEST_VALUE 65535
#define TOTAL_MILEAGE_WITH_TRIP_TEST_VALUE 987654
TEST_RECEIVE(total_mileage_in_nautical_miles_times_10, build_total_mileage(datagram, TOTAL_MILEAGE_TEST_VALUE), uint32)
...
//#define WATER_TEMPERATURE_CELSIUS_TEST_VALUE 81
TEST_RECEIVE(water_temperature_in_degrees_celsius_times_10, build_water_temperature(datagram, WATER_TEMPERATURE_TEST_VALUE, 0), int16)
assert_equal_int16(WATER_TEMPERATURE_TEST_VALUE * 10, status_value, "water_temperature from build_water_temperature()");
BUILD_AND_SIMULATE_DATAGRAM(water_temperature_in_degrees_celsius_times_10, build_precise_water_temperature(datagram, WATER_TEMPERATURE_TEST_VALUE));
assert_equal_int16(WATER_TEMPERATURE_TEST_VALUE, status_value, "water_temperature from build_precise_water_temperature()");
}
